...
"""
Train a PPO to make a drone travel from any arbitrary point A to another point B.
Uses the new refactored PPO training, for code readability and 
generally faster prototyping.

LEGACY. After this script we changed from a custom PPO script to StableBaselines
"""
